...
console.log('🍪 Copy this cookie value into your browser:\n');
console.log(`  Cookie Name:  mh_session`);
console.log(`  Cookie Value: ${sessionId}\n`);

console.log('📋 Browser DevTools Steps:');
console.log('  1. Open DevTools (F12)');
console.log('  2. Go to Application → Cookies → http://localhost:4321');
...
try {
  ...
  console.log('📝 Session also saved to .env.development');
  console.log('   (Note: You still need to manually set the cookie in your browser)\n');
} catch (error) {
  console.log('⚠️  Could not write to .env.development (not critical)');
}
