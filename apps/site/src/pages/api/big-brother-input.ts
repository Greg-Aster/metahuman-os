...
export const POST: APIRoute = async ({ cookies, request }) => {
  try {
    // Require authentication - only owners can interact with Big Brother
    ...
    // Send input to Big Brother stdin
...
/**
 * GET endpoint to check Big Brother session status
 */
