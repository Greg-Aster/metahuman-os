...
for (const removedPath of [
  ...
  'packages/core/src/active-operator/operator-policy-service.ts',
  'packages/core/src/active-operator/policy-contract.ts',
  'packages/core/src/queue/operator-policy-handler.ts',
  'packages/core/src/nodes/active-operator/operator-policy-context.node.ts',
  'packages/core/src/nodes/active-operator/operator-policy-decision.node.ts',
  'packages/core/src/nodes/active-operator/operator-policy-gate.node.ts',
  'packages/core/src/nodes/agency/outcome-reviewer.node.ts',
  'packages/server/src/queue/index.ts',
  'etc/cognitive-graphs/operator-policy.json',
  'etc/cognitive-graphs/outcome-reviewer.json',
