...
export const AGENT_CATALOG_DEFINITIONS: Record<string, AgentCatalogDefinition> = {
  ...
  'boredom-movement': {
    ...
    description: 'Supplies a boredom and engagement instruction with a current robot image to the shared Robot Operator Mode.',
    lifecycle: 'workflow',
  ...
  'robot-operator': {
    ...
    description: 'Owns inactivity timing and routes Robot Observer and Boredom Movement stimuli into the shared Robot Operator decision workflow while Active Operator is semi or full.',
    lifecycle: 'service',
    executionContext: 'system',
