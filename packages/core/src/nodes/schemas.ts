...
export const nodeSchemas: NodeSchema[] = [
  ...
  defineSchema({
    ...
    category: 'operator',
    inputs: [
      { name: 'decision', type: 'object', optional: true, description: 'Validated trigger decision' },
      { name: 'instruction', type: 'string', optional: true, description: 'Direct autonomy intention' },
      { name: 'memories', type: 'array', optional: true, description: 'Historical inspiration' },
      { name: 'observation', type: 'object', optional: true, description: 'Correlated robot observation' },
    ],
    outputs: [
    ...
    propertySchemas: {
      graph: { type: 'text', default: 'environment', label: 'Execution Workflow' },
      requireAction: { type: 'toggle', default: false, label: 'Require First Action' },
      continuationPolicy: { type: 'select', default: 'selector', label: 'Continuation Contract', options: ['selector', 'none', 'bounded'] },
      requiredCompletionBasis: { type: 'select', default: 'selector', label: 'Completion Evidence', options: ['selector', 'response', 'action_result', 'visual_observation', 'environment_state', 'user_input'] },
      visualEvidenceMode: { type: 'select', default: 'single', label: 'Visual Evidence Mode', options: ['single', 'comparison'] },
    },
    description: 'Starts one correlated autonomy cycle in the selected editable execution workflow.',
  }),
