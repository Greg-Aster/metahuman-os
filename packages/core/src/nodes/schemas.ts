...
export const nodeSchemas: NodeSchema[] = [
  ...
  defineSchema({
    ...
    outputs: [
      ...
      { name: 'rejectedCount', type: 'number', description: 'Rejected frame count' },
    ],
    description: 'Validates one bounded JPEG still and converts it to model image content.',
  }),
  defineSchema({
  ...
  defineSchema({
    ...
    inputs: [
      ...
      { name: 'taskState', type: 'object', optional: true, description: 'Canonical Environment Task State for this autonomy objective' },
    ],
    outputs: [
  ...
  defineSchema({
    ...
    outputs: [
      ...
      { name: 'instruction', type: 'string', description: 'Instruction for Boredom Autonomy' },
  ...
  defineSchema({
    ...
    outputs: [
      { name: 'queued', type: 'boolean', description: 'Whether Boredom Autonomy work was admitted' },
