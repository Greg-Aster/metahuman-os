...
- **What appears**:
  - ✅ Reflections (💭 Idle Thought) - Generated by reflector agent
  - ✅ Dreams (🌙 Dream) - Generated by dreamer agent during sleep
  - ✅ Reasoning stages (🤔 Reasoning) - Permanent record of thinking processes
- **What's hidden**:
  - ❌ User messages
  - ❌ Assistant responses
  - ❌ System messages
- **Purpose**: See the MetaHuman's internal thoughts, dreams, and reasoning without the noise of external conversation
