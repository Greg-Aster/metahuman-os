...
| retired 2026-08-27 | `dreamer/dreamer-learnings-extractor.node.ts` | Removed after persona learning was consolidated under the Psychoanalyzer-owned learning path. |
...
- 2026-07-07: `pnpm validate:node-defaults` passed the registry/default checks
  ...
  `docs/archive/audits/graph-json-persistence-migration.md`.
