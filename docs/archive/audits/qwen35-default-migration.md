...
- Local profile configuration copies and the active externally stored profile were migrated. Incompatible adapter selections were disabled and obsolete single-model files were removed.
