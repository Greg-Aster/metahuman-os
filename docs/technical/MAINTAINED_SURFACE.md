...
- `brain/services/robot-operator.ts` owns the Robot Observer and Boredom Movement timers. It admits finite work through the Work Coordinator and remains dormant in Reactive mode or while Sleep is active.
